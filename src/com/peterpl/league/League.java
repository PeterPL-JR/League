...
public class League {
	...
	public static SecondRound secondRound = new SecondRound();
	public static QuarterFinals quarterFinals = new QuarterFinals();
	public static SemiFinals semiFinals = new SemiFinals();
	public static ThirdPlaceMatch thirdPlaceMatch = new ThirdPlaceMatch();
	public static Final finalMatch = new Final();
	...
	public static CreateGameHandler createGame = new CreateGameHandler(createFrame);
	...
	public static KnockoutCreateHandler createKnockout = new KnockoutCreateHandler();

...
public class PotsMenu extends GamePanel implements Serializable {
	...
	public PotsMenu(int width, int height) {
		...
		String[] teams = { 
			"", "W³ochy", "Hiszpania", "Belgia", "Francja", "Anglia", "Portugalia", "Holandia", "Dania",
			"Szwecja", "Polska", "Chorwacja", "Czechy", "Rosja", "Austria", "Turcja", "Ukraina", "Serbia",
			"Szwajcaria", "S³owacja", "Wêgry", "Walia", "Finlandia", "Grecja", "Szkocja", "Islandia", 
			"Macedonia","Rumunia", "Norwegia", "Albania", "Irlandia", "S³owenia", "Bu³garia", "Izrael" 
		};

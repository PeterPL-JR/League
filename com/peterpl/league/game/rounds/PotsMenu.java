...
public class PotsMenu extends GamePanel implements Serializable {
	...
	public PotsMenu(int width, int height) {
		...
		/*
		String[] teams = { 
			"", "Włochy", "Hiszpania", "Belgia", "Francja", "Anglia", "Portugalia", "Holandia", "Dania",
			"Szwecja", "Polska", "Chorwacja", "Czechy", "Rosja", "Austria", "Turcja", "Ukraina", "Serbia",
			"Szwajcaria", "Słowacja", "Węgry", "Walia", "Finlandia", "Grecja", "Szkocja", "Islandia",
			"Macedonia","Rumunia", "Norwegia", "Albania", "Irlandia", "Słowenia", "Bułgaria", "Izrael"
		};
